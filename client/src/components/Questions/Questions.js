...
<section className="cd-faq">
    ...
    <div className="cd-faq-items">
        <ul id="basics" className="cd-faq-group">
            ...
            <li>
                <a className="cd-faq-trigger" href="#0">How do I change my password?</a>
            ...
            <li>
                <a className="cd-faq-trigger" href="#0">Can I remove a post?</a>
                <div className="cd-faq-content">
            ...
            <li>
                <a className="cd-faq-trigger" href="#0">How do reviews work?</a>
                <div className="cd-faq-content">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
                </div> 
            </li>
        ...
        <ul id="account" className="cd-faq-group">
            <li className="cd-faq-title"><h2>Account</h2></li>
            <li>
                <a className="cd-faq-trigger" href="#0">How do I change my password?</a>
                <div className="cd-faq-content">
            ...
            <li>
                <a className="cd-faq-trigger" href="#0">How do I delete my account?</a>
                <div className="cd-faq-content">
            ...
            <li>
                <a className="cd-faq-trigger" href="#0">How do I change my account settings?</a>
                <div className="cd-faq-content">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
                </div> 
            </li>
            ...
            <li>
                <a className="cd-faq-trigger" href="#0">I forgot my password. How do I reset it?</a>
                <div className="cd-faq-content">
        ...
        <ul id="payments" className="cd-faq-group">
            <li className="cd-faq-title"><h2>Payments</h2></li>
            <li>
                <a className="cd-faq-trigger" href="#0">Can I have an invoice for my subscription?</a>
                <div className="cd-faq-content">
            ...
            <li>
                <a className="cd-faq-trigger" href="#0">Why did my credit card or PayPal payment fail?</a>
                <div className="cd-faq-content">
            ...
            <li>
                <a className="cd-faq-trigger" href="#0">Why does my bank statement show multiple charges for one upgrade?</a>
                <div className="cd-faq-content">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
                </div> 
            </li>
